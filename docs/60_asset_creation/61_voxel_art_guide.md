...
Chunky deciduous tree: a broad rounded canopy of big cubes with a bobbly (protruding-cube)
surface, a red-brown flared trunk. Shorter and broader than the conifers. Box dimensions in
voxels equal block dimensions.

| Stage | Box (voxels = blocks) | Trunk footprint | Notes |
|---|---|---|---|
| Sapling | 5×5×~7 | 1 (clutter) | Small rounded blob on a thin trunk |
| Mature | ~11×11×~14 | 3 | Rounded canopy, flared trunk |
| Ancient | ~17×17×~20 | 5 | Big broad canopy, root-flared trunk |
...
- Autumn-fruiting: autumn canopy plus red apple cubes on the lower/outer surface — a **separate
