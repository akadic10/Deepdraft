...
| Block-Faithful Overview Renderer | Partial     | Current overview emits block-derived top faces and side faces with deterministic vertical material approximation. Same-height, same-material top faces are now greedily merged and sampled top IDs are validated against generated blocks. Side-face merging remains.       |
